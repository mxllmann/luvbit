...
import { PaperAirplaneIcon, EnvelopeIcon, ArrowUpRightIcon, ArrowRightCircleIcon } from '@heroicons/react/24/solid';
...
{/* 
                <div className="w-full text-left">
                              <label className="text-xs text-zinc-400 mb-1 block">Send it to someone (optional):</label>
                              <div className="flex gap-2">
                                <input
                                  ...
                                  value={email}
                                  onChange={(e) => setEmail(e.target.value)}
                                  className="flex-1 w-full px-3 py-2 rounded bg-zinc-800 text-white border border-zinc-600 focus:outline-none focus:border-pink-400 text-sm"
                                />
                                <button
                                  onClick={handleSend}
                                  className="group cursor-pointer relative flex items-center justify-center px-6 py-4 rounded-md text-white bg-pink-600 hover:bg-pink-700 active:bg-pink-800
                                    border-2 border-pink-400 font-bold shadow-[0_0_8px_#ec4899,0_0_16px_#ec4899] 
                                    hover:shadow-[0_0_12px_#db2777,0_0_24px_#db2777] 
                                    active:shadow-[0_0_8px_#9d174d,0_0_16px_#9d174d] 
                                    transition-all duration-300 ease-in-out scale-100 hover:scale-105 active:scale-95
                              ...
                              <p className="text-zinc-500 text-[10px] mt-2 italic">This message is anonymous and not stored with the email.</p>
                            </div> */}
